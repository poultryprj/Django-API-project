...
class ShopOwner(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='shops_shop_owners_api')
...
class ShopRoute(models.Model):
    ...
    route_id = models.ForeignKey(RouteModel, on_delete=models.SET_NULL, null=True, related_name='route_shoproute')
    shop_id = models.ForeignKey(ShopModel, on_delete=models.SET_NULL, null=True, related_name='shop_shoproute')
